...
return {
  ...
  keys = {
    ...
    { "<leader>fgf", ":lua Snacks.picker.git_files()<CR>", desc = "Open Git Files Picker", silent = true },
    { "<leader>fr", ":lua Snacks.picker.recent()<CR>", desc = "Open Recent Picker", silent = true },
