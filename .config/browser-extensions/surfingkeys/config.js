...
const hintsCss =
  "font-size: 15px; font-family: 'JetBrains Mono NL', 'Cascadia Code', 'Helvetica Neue', Helvetica, Arial, sans-serif; border: solid 1px; border-radius: 25%; border-color: #e0def4; color: #ebbcba !important; background: #191724; background-color: #191724";

api.Hints.style(hintsCss);
api.Hints.style(hintsCss, "text");
api.Visual.style("cursor", "background-color: #c4a7e7;");
