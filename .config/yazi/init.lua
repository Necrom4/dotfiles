...
THEME.git.modified = ui.Style():fg("#7AA2F7")
THEME.git.added_sign = ""
THEME.git.added = ui.Style():fg("#9ECE6A")
THEME.git.untracked_sign = ""
THEME.git.untracked = ui.Style():fg("#E0AF68")
THEME.git.ignored_sign = ""
THEME.git.ignored = ui.Style():fg("#565F89")
THEME.git.deleted_sign = ""
THEME.git.deleted = ui.Style():fg("#DB4B4B")
THEME.git.updated_sign = "󰚰"
THEME.git.updated = ui.Style():fg("#1ABC9C")
require("git"):setup()
