...
THEME.git.modified = ui.Style():fg("#82AAFF")
THEME.git.added_sign = ""
THEME.git.added = ui.Style():fg("#C3E88D")
THEME.git.untracked_sign = ""
THEME.git.untracked = ui.Style():fg("#FFC777")
THEME.git.ignored_sign = ""
THEME.git.ignored = ui.Style():fg("#636DA6")
THEME.git.deleted_sign = ""
THEME.git.deleted = ui.Style():fg("#C53B53")
THEME.git.updated_sign = "󰚰"
THEME.git.updated = ui.Style():fg("#4FD6BE")
require("git"):setup()
